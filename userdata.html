...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" type="text/css"  href="css/datauser.css">
  ...
  <nav>
    ...
    <form>
      ...
      <p>
          <label>Micro Cluster</label>
          <input type="text" class="label" name="Microcluster">
      </p>
      <p>
          <label>Jabatan</label>
          <input type="text" class="label" name="jabatan">
      </p>
      <p>
        <label>Nik</label>
        <input type="text" class="label" name="nik">
    </p>
  </div>
      <p class="button"> 
          <input type="submit" name="user" value="Edit" class="btn">
      </p>
  </form>
